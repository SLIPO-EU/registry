define({ "api": [
  ...
  },
  {
    ...
    "description": "<p>The Registry stores information for each POI and assings a UUID to each POI.</p>",
    "parameter": {
      "fields": {
        "Parameters[]": [
          {
          ...
          },
          {
            ...
            "optional": false,
            "field": "names",
            "description": "<p>The​ ​ known​ ​ names​ ​ of​ ​ the​ ​ POI</p>"
          },
          {
            "group": "Parameters[]",
            "type": "String",
            "optional": false,
            "field": "category",
            "description": "<p>The ​ categories​ ​ this​ ​ POI​ ​ belongs​ ​ to</p>"
          },
          {
            "group": "Parameters[]",
            "type": "Object",
  ...
  },
  {
    "type": "post",
    "url": "register",
    "title": "Register POIs with given UUID",
    "version": "1.0.0",
    "name": "addPOIsbatch",
    "group": "Registration",
    "permission": [
    ...
    "description": "<p>The Registry stores information for each POI and saves the UUID its given in tempid to each POI.</p>",
    "parameter": {
      "fields": {
        "Parameters[]": [
          {
      ...
      "examples": [
        {
          "title": "Request Example",
          "content": "POST https://registry.dev.slipo.eu/registerBatch [\n{\n  \"tmpId\": \"94c15086-5b8b-4a72-b02f-2fb7595c6bd0\",\n  \"source\": \"AthenaRC\",\n  \"sourceId\": \"IMSI\",\n  \"names\": \"Athena Research Center\",\n  \"category\": \"Research Center\",\n  \"geometry\": {\n        \"type\": \"Point\",\n        \"coordinates\": [\n          23.80241096019745,\n          38.036686288593074\n        ]\n      }\n}\n]",
          "type": "json"
        }
      ]
    },
    ...
    "filename": "src/webapp-action/Registration2.js",
    "groupTitle": "Registration"
  }
] });
